...
function showKapeAlamid() {
    ...
    const content = `
       <div class="coffee-details">
            <img src="alamid.png" alt="Barako Coffee" class="coffee-image">
...
function showBenguet() {
    ...
    const content = `
    <div class="coffee-details">
         <img src="benguet.png" alt="Barako Coffee" class="coffee-image">
         <div class="coffee-text">
...
function showSagada() {
    ...
    const content = `
    <div class="coffee-details">
         <img src="sagada.png" alt="Barako Coffee" class="coffee-image">
         <div class="coffee-text">
         <h2>Sagada Coffee</h2>
...
function showSulu() {
    ...
    const content = `
    <div class="coffee-details">
         <img src="sulu.png" alt="Barako Coffee" class="coffee-image">
         <div class="coffee-text">
         <h2>Sulu Coffee</h2>
...
function showKapengBarako() {
    ...
    const content = `
    <div class="coffee-details">
         <img src="barako.png" alt="Barako Coffee" class="coffee-image">
         <div class="coffee-text">
         <h2>Kapeng Barako</h2>
...
function showKapengTagalog() {
    ...
    const content = `
    <div class="coffee-details">
         <img src="tagalog.png" alt="Barako Coffee" class="coffee-image">
         <div class="coffee-text">
...
function showExcelsa() {
    ...
    const content = `
    <div class="coffee-details">
         <img src="excelsa.png" alt="Barako Coffee" class="coffee-image">
         <div class="coffee-text">
...
function showLiberica() {
    ...
    const content = `
    <div class="coffee-details">
         <img src="liberica.png" alt="Barako Coffee" class="coffee-image">
         <div class="coffee-text">
